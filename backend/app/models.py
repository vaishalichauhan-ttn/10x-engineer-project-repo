...
class PromptBase(BaseModel):
    ...
    Attributes:
        ...
        collection_id (Optional[str]): An optional identifier for the
            collection this prompt belongs to.
...
class PromptPatch(BaseModel):
    ...
    Attributes:
        title (Optional[str]): The title of the prompt, optional for
            partial updates.
        content (Optional[str]): The content of the prompt, optional for
            partial updates.
        description (Optional[str]): A description of the prompt,
            optional for partial updates.
        collection_id (Optional[str]): An optional identifier for the
            collection, optional for partial updates.
...
class Prompt(PromptBase):
    """Model representing a full prompt with metadata.
    ...
    Attributes:
        ...
        updated_at (datetime): Timestamp when the prompt was last
            updated, generated by default.
...
class CollectionBase(BaseModel):
    ...
    Attributes:
        name (str): The name of the collection, with a min length of 1
...
class Collection(CollectionBase):
    ...
    Attributes:
        id (str): Unique identifier for the collection, generated
            automatically.
        created_at (datetime): Time when the collection was created,
