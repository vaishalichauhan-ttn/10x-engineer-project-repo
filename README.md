...
- CORS configured via `CORS_ALLOW_ORIGINS` (defaults to local frontend origins).
...
- CORS origins can be configured with `CORS_ALLOW_ORIGINS` (comma-separated), for example:
